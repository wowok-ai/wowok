...
export const GUARD_QUERIES = [
    ...
    { module: MODULES.demand, query_name: 'Type', query_id: 311, parameters: [], return: ValueType.TYPE_STRING, description: 'The type name(eg. 00000000000000000000000000000002::sui::SUI)', parameters_description: [] },
    { module: MODULES.demand, query_name: 'Type with Original Ids', query_id: 312, parameters: [], return: ValueType.TYPE_STRING, description: 'The type name(eg. 00000000000000000000000000000002::sui::SUI) with original ids', parameters_description: [] },
    ...
    { module: MODULES.service, query_name: 'Type', query_id: 423, parameters: [], return: ValueType.TYPE_STRING, description: 'The type name(eg. 00000000000000000000000000000002::sui::SUI)', parameters_description: [] },
    { module: MODULES.service, query_name: 'Type with Original Ids', query_id: 424, parameters: [], return: ValueType.TYPE_STRING, description: 'The type name(eg. 00000000000000000000000000000002::sui::SUI) with original ids', parameters_description: [] },
    ...
    { module: MODULES.order, query_name: 'Type', query_id: 515, parameters: [], return: ValueType.TYPE_STRING, description: 'The type name(eg. 00000000000000000000000000000002::sui::SUI)', parameters_description: [] },
    { module: MODULES.order, query_name: 'Type with Original Ids', query_id: 516, parameters: [], return: ValueType.TYPE_STRING, description: 'The type name(eg. 00000000000000000000000000000002::sui::SUI) with original ids', parameters_description: [] },
    ...
    { module: MODULES.payment, query_name: 'Type', query_id: 1216, parameters: [], return: ValueType.TYPE_STRING, description: 'The type name(eg. 00000000000000000000000000000002::sui::SUI)', parameters_description: [] },
    { module: MODULES.payment, query_name: 'Type with Original Ids', query_id: 1217, parameters: [], return: ValueType.TYPE_STRING, description: 'The type name(eg. 00000000000000000000000000000002::sui::SUI) with original ids', parameters_description: [] },
    ...
    { module: MODULES.treasury, query_name: 'Type', query_id: 1428, parameters: [], return: ValueType.TYPE_STRING, description: 'The type name(eg. 00000000000000000000000000000002::sui::SUI)', parameters_description: [] },
    { module: MODULES.treasury, query_name: 'Type with Original Ids', query_id: 1429, parameters: [], return: ValueType.TYPE_STRING, description: 'The type name(eg. 00000000000000000000000000000002::sui::SUI) with original ids', parameters_description: [] },
    ...
    { module: MODULES.arbitration, query_name: 'Type', query_id: 1511, parameters: [], return: ValueType.TYPE_STRING, description: 'The type name(eg. 00000000000000000000000000000002::sui::SUI)', parameters_description: [] },
    { module: MODULES.arbitration, query_name: 'Type with Original Ids', query_id: 1512, parameters: [], return: ValueType.TYPE_STRING, description: 'The type name(eg. 00000000000000000000000000000002::sui::SUI) with original ids', parameters_description: [] },
    ...
    { module: MODULES.arb, query_name: 'Type', query_id: 1613, parameters: [], return: ValueType.TYPE_STRING, description: 'The type name(eg. 00000000000000000000000000000002::sui::SUI)', parameters_description: [] },
    { module: MODULES.arb, query_name: 'Type with Original Ids', query_id: 1614, parameters: [], return: ValueType.TYPE_STRING, description: 'The type name(eg. 00000000000000000000000000000002::sui::SUI) with original ids', parameters_description: [] },
];
...
export class Guard {
    ...
    static QueryAddressIdentifiers(guard, onQueryAnswer, sender) {
        ...
        Protocol.Client().devInspectTransactionBlock({ sender: sender, transactionBlock: txb }).then((res) => {
            ...
            const identifiers = bcs.vector(bcs.u8()).parse(Uint8Array.from(res.results[0].returnValues[0][0]));
...
export class GuardMaker {
    ...
    add_constant(type, value, identifier, bNeedSerialize = true) {
        if (identifier === undefined) {
            if (value === undefined)
                ...
                identifier = GuardMaker.getConstIndex();
        }
    ...
    add_query2(query_id, object_address_from) {
        ...
        if (typeof (object_address_from) == 'string') {
            ...
            if (!v)
                ERROR(Errors.Fail, 'object_address_from not in constant:' + query_id);
