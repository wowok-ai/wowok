...
var C = "object" == typeof process && process ? process : {};

var emitWarning = (e, t, i, r) => {
  "function" == typeof C.emitWarning ? C.emitWarning(e, t, i, r) : console.error(`[${i}] ${t}: ${e}`);
};
...
if (void 0 === L) {
  ...
  var N = "1" !== C.env?.LRU_CACHE_IGNORE_AC_WARNING;
  var warnACPolyfill = () => {
    if (!N) {
      return;
    }
...
var I = getDefaultExportFromCjs(F.exports);
...
var crawlChainedExpressions = (e, t, i, r, s) => {
  if (exports.ts.isPropertyAccessExpression(e.expression) && R.has(e.expression.name.text)) {
    ...
    if (n && exports.ts.isIdentifier(n)) {
      var u = s.languageService.getProgram().getTypeChecker();
      var p = u.getSymbolAtLocation(n)?.valueDeclaration;
      if (p && exports.ts.isFunctionDeclaration(p)) {
        n = p;
      } else if (p && exports.ts.isVariableDeclaration(p) && p.initializer) {
        n = p.initializer;
      }
    }
    if (n && (exports.ts.isFunctionDeclaration(n) || exports.ts.isFunctionExpression(n) || exports.ts.isArrowFunction(n))) {
      var h = n.parameters[a ? 1 : 0];
      if (h) {
        var f = crawlScope(h.name, t, i, r, s, !0);
        if (f.length) {
          o.push(...f);
        }
      }
...
var P = new Set([ "populate", "client", "unmask", "_unmask", "_optional", "_relayPagination", "_simplePagination", "_required", "optional", "required", "arguments", "argumentDefinitions", "connection", "refetchable", "relay", "required", "inline" ]);
...
var U = [ 52001, 52004, 52003, $, V, j, W, M ];
...
var runDiagnostics = (t, {nodes: i, fragments: r}, s, a) => {
  ...
  var l = i.map((t => {
    ...
    var m = new Set([ ...P, ...a.config.clientDirectives || [] ]);
    var x = getDiagnostics(l, g, void 0, void 0, d).filter((e => {
